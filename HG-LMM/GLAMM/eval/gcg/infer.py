...
from GLAMM.eval.ddp import *
from GLAMM.model.GLaMM import GLaMMForCausalLM
from GLAMM.model.llava import conversation as conversation_lib
from GLAMM.model.llava.mm_utils import tokenizer_image_token
from GLAMM.model.SAM.utils.transforms import ResizeLongestSide
from GLAMM.tools.utils import DEFAULT_IM_END_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IMAGE_TOKEN, IMAGE_TOKEN_INDEX
...
def parse_args():
    ...
    parser.add_argument("--img_dir", required=False, default="../data/GCG/GranDf_HA_images/val_test",
