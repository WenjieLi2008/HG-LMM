...
from hglmm.datasets.png import PNGDataset, concat_datasets, custom_collate_fn
from llava.modeling_llava import CustomLlavaForConditionalGeneration
from hglmm.datasets.llava_processors import CustomLlavaImageProcessor
from hglmm.models.frozen_llava import HGFrozenLlava
from xtuner.utils.templates import PROMPT_TEMPLATE
from mmdet.models import DiceLoss, CrossEntropyLoss
from mmdet.datasets import RefCocoDataset
from hglmm.datasets.transforms import PILLoadImageFromFile, RefCOCO2PNG
...
lmm_name = llava_name = 'llava-hf/llava-1.5-7b-hf'
...
tokenizer = dict(
    ...
    pretrained_model_name_or_path=llava_name,use_fast=False)
...
optim_wrapper = dict(
    ...
    loss_scale='dynamic',
    dtype='bfloat16',
    _skip_convert_to_iter_based=True
        )
...
default_hooks = dict(
    ...
    checkpoint=dict(
        type=CheckpointHook,
        out_dir='/Storage/persenal/lwj/F-LMM/work_dirs/llava-1.5-7b/addstemmax_only234attn_sam',
        by_epoch=True,
        interval=1,
        save_optimizer=True,
        max_keep_ckpts=10),
