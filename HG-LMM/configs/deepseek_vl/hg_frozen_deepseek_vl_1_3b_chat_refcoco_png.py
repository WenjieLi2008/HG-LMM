...
from hglmm.models.frozen_deepseek_vl import HGFrozenDeepseekVL
...
# lr = 2e-4  # 下调基础学习率（原1e-4 → 5e-5）
# warmup_ratio = 0.05  # 延长预热到10%（原3%）
...
default_hooks = dict(
    ...
    checkpoint=dict(
        type=CheckpointHook,
        out_dir='/Storage/persenal/lwj/HG-LMM/work_dirs/deepseek_vl_1_3b/',
        by_epoch=True,
        interval=1,
        save_optimizer=True,
        max_keep_ckpts=10,
