...
from LISA import conversation as conversation_lib

# from LISA.model.llava.constants import (DEFAULT_IMAGE_TOKEN, IGNORE_INDEX,
#                                    IMAGE_TOKEN_INDEX)
from LISA.constants import (DEFAULT_IMAGE_TOKEN, IGNORE_INDEX,
                                   IMAGE_TOKEN_INDEX)
from LISA.mm_utils import tokenizer_image_token
...
def collate_fn(
    ...
    if conv_type == "llava_v1":
        sep = conv.sep + conv.roles[0] + ": "
    else:
        sep = "[/INST] "
    sep2 = '###Human'
    for conversation, target in zip(conversation_list, targets):
        total_len = int(target.ne(0).sum())
